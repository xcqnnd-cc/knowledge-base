...
const config: Config = {
  ...
  stylesheets: [
    {
      ...
      type: 'text/css',
      integrity:
        'sha384-n8MVd4RsEw0980x9kmf9kE0BqQ8BqBw0D0H0r05S0y0Qv0BqB000000000000000',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} 我的全栈知识库. Built with Docusaurus.`,
    },
    prism: {
